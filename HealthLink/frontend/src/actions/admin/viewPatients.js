...
export const fetchPatients = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get('https://healtlink.onrender.com/api/admin/patients');
...
export const verifyPatient = (patientId) => async (dispatch) => {
  try {
    await axios.put(`https://healtlink.onrender.com/api/admin/patients/verify/${patientId}`);
...
export const unverifyPatient = (patientId) => async (dispatch) => {
  try {
    await axios.put(`https://healtlink.onrender.com/api/admin/patients/unverify/${patientId}`);
